<?php
/**
 * Ivory Tower's gallery content template file.
 *
 * This is the content template for the gallery post format.
 *
 * @since 0.2.0
 * 
 * @package Ivory_Tower
...
<?php if ( ( !is_singular( get_post_type() ) ) ) : // If this is not a singular post, display a feature image and the excerpt. ?>
...
<div <?php hybrid_attr( 'entry-summary' ); ?>>
	...
	<p class="gallery-count"><?php printf( _n( 'This gallery contains %s item.', 'This gallery contains %s items.', $count, 'ivory-tower' ), $count ); ?></p>
</div>
